      ...
      <div class="container">
        <div class="logotype">
          <a class="logo" @click="Home">
            <UIIcon :icon="logoIcon" width="35px" height="35px" />
            ...
            <div class="right">
              <div class="language">
                <a class="switch-lang">
                  ...
                  <UIIcon :size="22" :icon="downArrowheadIcon" />
                </a>
              </div>
                  ...
                  <v-menu class="v-menu-header">
                    <template v-slot:activator="{ props }">
                      <div v-bind="props" class="userProfile">
                        ...
                        <UIIcon :icon="downArrowheadIcon" :size="22" />
                      </div>
                    </template>
                    <v-list
                      class="v-list-header"
...
<script setup>
  ...
  import { languageIcon, downArrowheadIcon, logoIcon } from '@/assets/icons';
